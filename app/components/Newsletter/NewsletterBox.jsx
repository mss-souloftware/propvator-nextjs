        ...
        <div className={styles.newsletterWrapper}>
            <form action="">
                <div className='w-full md:w-10/12 mx-auto flex flex-wrap justify-center'>
                    ...
                    <button type='submit' className='flex items-center justify-center p-2 text-center'>Subscribe <Image className='ml-1' src='/Images/Global/send.svg' width={20} height={20} /> </button>
                </div>
            </form>
